   ...
   MdbFilePath = "u14u12.mdb"
   MyConn.Open "Driver={Microsoft Access Driver (*.mdb)}; DBQ=" & MdbFilePath & ";"

   del_query = "DELETE * FROM [Racer-Score]"
   wscript.echo del_query
   MyConn.Execute del_query

   SQL_query = "SELECT * FROM [racer-runs]"
...
sub writescore
	...
	ins_query = "INSERT INTO [Racer-Score](ussa,name,class,gender,score_class,tie_score_class) "
