   ...
   del_query = "DELETE * FROM [Racer-Score-U10U12]"
   wscript.echo del_query
   MyConn.Execute del_query

   SQL_query = "SELECT * FROM [racer-runs-U10U12]"
...
sub writescore
	...
	ins_query = "INSERT INTO [Racer-Score-U10U12](ussa,name,class,gender,score_class,tie_score_class) "
